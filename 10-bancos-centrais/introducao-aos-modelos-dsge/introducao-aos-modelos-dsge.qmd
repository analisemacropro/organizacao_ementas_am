...
O curso é organizado em onze módulos de duas horas de vídeo cada, na sequência abaixo. A ordem importa: cada módulo depende do anterior, alternando derivação teórica e implementação no DYNARE.

## Módulo 1 — Fundamentos dos modelos DSGE

Apresentação da abordagem de equilíbrio geral dinâmico e estocástico e por que ela se tornou central na análise macroeconômica. O módulo estabelece o vocabulário do curso — agentes otimizadores, restrições, choques e expectativas racionais — e mostra o mapa do percurso até o CHORINHO. O DYNARE já é instalado aqui, para que a parte computacional acompanhe a teoria desde o começo.
...
## Módulo 2 — Equilíbrio com preços flexíveis e a Curva de Phillips
...
## Módulo 3 — Curva IS intertemporal e regra de política monetária
...
## Módulo 4 — Implementação do modelo básico no DYNARE

Mão na massa: escrevendo o código do modelo do zero. O módulo percorre a anatomia de um arquivo `.mod` — blocos de variáveis, parâmetros, equações e choques — e trata dos dois passos que costumam travar quem começa: encontrar o steady state e log-linearizar em torno dele. Ao final, o modelo roda e as saídas passam a ser lidas com critério.
...
## Módulo 5 — Unicidade da solução e o princípio de Taylor
...
## Módulo 6 — Respostas impulsionais: DSGE e mundo real
...
## Módulo 7 — Enriquecendo o modelo básico
...
## Módulo 8 — A economia brasileira no modelo
...
## Módulo 9 — CHORINHO: estrutura e derivação
...
## Módulo 10 — CHORINHO no DYNARE

Implementação computacional completa. O CHORINHO é codificado do zero no DYNARE, com steady state, calibração e as verificações que confirmam que o modelo está correto. O módulo trata também de depuração e de organização de código, para que o modelo continue utilizável depois do curso.
...
## Módulo 11 — Simulação e comportamento da economia brasileira
...
Curso completo **O Modelo de Pequeno Porte (MPP) do Banco Central do Brasil**, também com o professor Luciano Vereda Oliveira, com 16 horas de vídeo. O MPP é o modelo semiestrutural que apoia as decisões do COPOM — um complemento direto ao arcabouço DSGE visto aqui.
...
A matrícula dá acesso aos onze módulos do curso e a todo o material de apoio, incluindo os arquivos `.mod` do DYNARE, além do curso do MPP como bônus. Garantia de reembolso incondicional em até 7 dias.
