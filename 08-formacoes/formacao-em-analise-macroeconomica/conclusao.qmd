...
Você percorreu os seis blocos da Formação em Análise Macroeconômica e hoje conduz uma análise completa: da coleta de dados brutos à previsão de indicadores e à comunicação de resultados, unindo teoria econômica e análise quantitativa.

O caminho, em resumo:

- **Bloco 1** — nivelamento técnico em SQL, R e Python
- **Bloco 2** — fundamentos da análise macroeconômica
- **Bloco 3** — métodos quantitativos aplicados
- **Bloco 4** — modelagem e previsão macroeconômica
- **Bloco 5** — IA aplicada a dados textuais e macroeconômicos
- **Bloco 6** — projeto final automatizando relatórios de conjuntura
...
Continue praticando com dados reais e acompanhe as divulgações de indicadores para testar suas análises contra a realidade.

# Onde você pode atuar com essa formação

Os cargos que listamos nas boas-vindas, agora com o que da trilha sustenta cada um:

- **Economista / Analista de Research Macro** — conjuntura (Bloco 2) com modelagem e previsão (Bloco 4): ler indicadores, construir cenários e defender uma visão com evidência.
- **Analista de Mercado Financeiro** — a leitura de IPCA, PIB e mercado de trabalho (Bloco 2) com modelos de previsão (Bloco 4) sustenta decisões de alocação e risco.
- **Economista de Consultoria ou Órgão Público** — métodos quantitativos (Bloco 3) e relatórios automatizados (Bloco 6) para análises técnicas recorrentes.
- **Analista de Conjuntura** — transformar dados brutos em análise interpretativa (Bloco 2), com sazonalidade, tendências e comparações.
- **Pesquisador(a) ou Professor(a)** — econometria, séries temporais e macroeconometria (Blocos 3 e 4) dão o rigor metodológico para pesquisa e docência.
- **Cientista de Dados com foco macro** — machine learning e NLP aplicados a comunicados do FED e do Copom (Bloco 5). Poucos cientistas de dados dominam o contexto macro, e poucos economistas dominam essas técnicas.
- **Engenheiro(a) de Machine Learning** — os modelos do Bloco 4 com a automação de relatórios do Bloco 6: o que faz um modelo rodar sozinho, e não só no notebook.
- **Especialista em IA aplicada a economia** — o Bloco 5 traz IA sobre dados textuais e macroeconômicos, aplicável a qualquer área que precise extrair sinal de documentos e séries.
