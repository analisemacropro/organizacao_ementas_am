...
Antes de acessar o link acima, **marque esta aula como concluída** no botão da plataforma, logo abaixo desta página. A plataforma só reconhece um bloco como finalizado — e libera o certificado correspondente — quando cada aula está marcada como concluída.

Se você clicar no link do certificado sem ter feito essa marcação, a página da formação vai abrir, mas o certificado ainda não estará disponível para emissão. O mesmo vale para os blocos anteriores: se ficou alguma aula sem marcar em algum deles, volte e confirme antes de seguir.
:::

# Seus próximos passos

1. **Marque esta aula e cada um dos 5 cursos como concluídos** na plataforma. Sem essa marcação, o certificado não é emitido — mesmo que você já tenha assistido a todas as aulas.
