...
Você percorreu os seis blocos da formação Do Zero à Análise de Dados Econômicos e Financeiros usando Python e Inteligência Artificial: 366 aulas. Saiu de um ponto de partida que talvez fosse nunca ter escrito uma linha de código e construiu uma base completa em Python aplicado a economia e finanças.

O caminho, em resumo:

- **Bloco 1** — pensar como analista, SQL e programação em Python
...
- **Bloco 5** — mercado financeiro, macroeconometria, políticas públicas e IA aplicada
...
- **Analista de Dados (economia e finanças)** — o ciclo completo (Bloco 1) com coleta, tratamento e apresentação em Python (Blocos 2 e 4).
- **Cientista de Dados** — estatística e modelagem preditiva (Bloco 3) com IA e machine learning (Bloco 5): construir modelos, avaliar erros e iterar até a previsão confiável.
- **Economista com foco em modelagem** — econometria, macroeconometria e previsão macro com IA (Blocos 3 e 5).
...
- **Analista de Risco e de Investimentos** — Python para Investimentos, Mercado Financeiro, Modelos Financeiros e Demonstrativos (Bloco 5).
- **Profissional que aplica IA no dia a dia** — engenharia de prompt e integração de modelos com Python (Bloco 5), aplicáveis a qualquer área.
